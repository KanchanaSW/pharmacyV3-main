    ...
    <form:form action="/ManageRequest" method="POST" modelAttribute="ManageRequest">
        ...
        <div class="row">
            ...
            <div class="col-sm">
                ...
                <input type="number" step="any" placeholder="35.00" class="form-control" id="price" value="" name="price"
                       required>
        ...
        <br>
        <div class="row">
            <div class="col-sm"><button style="width: 370px;" type="submit" value="ManageRequest" class="btn btn-primary">Add item</button>
                <div class="Message">
